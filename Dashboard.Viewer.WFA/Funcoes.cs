...
namespace Dashboard.Viewer.WFA
{
    public class Funcoes
    {
        ...
        {
            return Convert.ToDateTime("01/" + month.ToString() + "/" + year.ToString());
        }

        public static DateTime LastDay(int month, int year)
        {
            return Convert.ToDateTime(DateTime.DaysInMonth(year, month).ToString() + "/" + month.ToString() + "/" + year.ToString());
        }

        public static DateTime AnyDay(int day, int month, int year)
        {
            return Convert.ToDateTime(day.ToString() + "/" + month.ToString() + "/" + year.ToString());
        }
        ...
        public static string ConfigureDateCondition(string campo, string sinal, DateTime data, int tipodb = 0)
        {
            if (tipodb.Equals(3))
                ...
                return campo + " " + sinal + " " + data.ToShortDateString();
        }
